...
double_impact = media.Movies(
              "Double Impact",
              "classical sakespearian twin entanglement with\
              lots of kicking and love makeing",
              "https://upload.wikimedia.org/wikipedia/en/2/24/Double\
_impact.jpg",
              "https://www.youtube.com/watch?v=xyUqIuwOEzI")

# create a array of all the movie object which will be in the website
